...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    function executeOperation(
        ...
        dexContract.depositUSDC(100000000); // Deposit 100 USDC into the Dex contract.
        dexContract.buyDAI(); // Swap the entire amount for DAI.
        dexContract.depositDAI(dai.balanceOf(address(this))); // Deposit D
        dexContract.sellDAI();
